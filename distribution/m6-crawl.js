        ...
        const resultPromise = new Promise((resolve, reject) => {
            ...
            function processDocs() {
                ...
                result.forEach(item => {
                    ...
                    sendBatch.push({ [ngram]: { freq: freq, url: url } });
                    if (resultCount === Object.keys(result).length) {
                        console.log("about to append for batch")
                        distribution.local.store.appendForBatch(sendBatch, { gid: "ngrams"}, (e, v) => {
                            console.log("appended for batch!");
